...
export default function HeroisCriarScreen() {
  ...
  const [numero_episodios, setEpisodios] = useState("");
  const [ano_lancamento, setLancamento] = useState("");
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.conteudo}>
        ...
        <TextInput
          ...
          placeholder="Ex: Numero de Episodios"
        />
